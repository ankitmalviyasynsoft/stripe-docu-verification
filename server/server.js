    ...
    case 'identity.verification_session.requires_input': {
      ...
      switch (verificationSession.last_error.code) {
        case 'document_unverified_other': {
          ...
          console.log('document_unverified_other')
          break;
        }
        case 'document_expired': {
          // The document was expired
          console.log('document_expired')
          break;
        }
        case 'document_type_not_supported': {
          console.log('document_type_not_supported')
...
app.listen(4000, () => console.log(`Node server listening at http://localhost:4000`));